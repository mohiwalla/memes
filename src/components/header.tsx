		...
		<header className="sticky top-0 z-10 bg-meme-bg px-4 pt-9 pb-4 min-[480px]:px-6 sm:px-12 border-b-2 border-meme-ink/15 rounded-b-2xl">
			<div className="flex flex-wrap items-center justify-between gap-5 max-md:flex-col max-md:items-stretch max-md:gap-4">
				<div className="flex items-center gap-2.5 font-heading max-[479px]:gap-2">
					...
					<div className="text-[34px] leading-none tracking-tight max-[479px]:text-[1.75rem]">
						MEME
				...
				<div className="flex flex-wrap items-center gap-2.5 max-md:w-full max-md:flex-col max-md:items-stretch">
					<div className="relative flex items-center max-md:w-full">
						...
						<div className="absolute top-1/2 -mt-px -translate-1/2 -right-1 flex h-6 min-w-6 items-center justify-center rounded-full border-2 border-meme-ink bg-meme-accent px-1.5 font-sans text-[11px] font-bold text-meme-ink shadow-[2px_2px_0_var(--color-meme-ink)] max-[479px]:right-1">
							{filteredCount}
						</div>
						...
						<input
							...
							className="w-full min-w-0 rounded-full border-[2.5px] border-meme-ink bg-meme-paper py-2.5 pr-12 pl-9 font-sans text-sm font-medium text-meme-ink outline-none shadow-[3px_3px_0_var(--color-meme-ink)] transition-all placeholder:text-meme-ink-2 focus:shadow-[5px_5px_0_var(--color-meme-accent)] md:w-77.5"
						/>
					</div>

					<Button
						variant="outline"
						className="shrink-0 gap-2.5 border-2 px-5! py-4.75 hover:bg-meme-accent2 max-md:w-full max-md:justify-center"
						nativeButton={false}
						render={
							<a
								href={REPO_URL}
			...
			<div className="mt-5 overflow-hidden whitespace-nowrap rounded-full border-2 border-meme-ink bg-meme-ink py-3 font-heading text-sm tracking-widest text-meme-accent2 shadow-[4px_4px_0_var(--color-meme-ink)] -rotate-1 max-md:mt-4 max-md:text-xs">
